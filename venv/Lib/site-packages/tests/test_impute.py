...
class TestImpute(unittest.TestCase):
    def test_impute(self):
        ...
        self.assertTrue(
            (
                filled.values.flatten()
                == np.array([5, 5, 10, 50, 15, 15, 15, 15, 10, 10])
            ).all()
        )
        ...
        self.assertTrue(
            (
                filled.values.flatten()
                == np.array([5, 5, 10, 50, 15, 15, 10, 20, 10, 10])
            ).all()
        )
        ...
        self.assertTrue(
            (
                filled.values.flatten()
                == np.array([5, 5, 10, 50, 15, 15, 10, 12.5, 10, 10])
            ).all()
        )
        ...
        self.assertTrue(
            (
                filled.values.flatten()
                == np.array([5, 5, 5, 5, 10, 50, 15, 15, 10, 10])
            ).all()
        )
        ...
        self.assertTrue(
            (filled.values.flatten() == np.array([5, 5, 10, 50, 15, 15, 10, 10])).all()
        )
